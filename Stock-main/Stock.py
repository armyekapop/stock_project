...
class CategoriesWindow(Screen):
    def on_kv_post(self, obj):
        ...
        meat = []
        with open('D:\python\Stock-main\meat.txt') as reader:
        ...
        for i in meat:
            ...
            # file_meat.read()
            label = Label(text=testMeat[0], font_size=24, size_hint_y=None, height=50)
            amount = Label(text=testMeat[1], font_size=24, size_hint_y=None, height=50, size_hint_x=0.1)
