...
class CategoriesWindow(Screen):
    ...
    def on_kv_post(self, obj):
        ...
        self.ids.GL.height = (40*(n+1)+70*n) # กำหนดช่วงความสูงของ GridLayout ใน ScrollView
        for i in range(len(items)):
            ...
            clear = Button(background_normal='D:/python/Project_Stock-main/pic/bin.png',size_hint=(None,None ),height=70,width=70)
            reset = Button(background_normal='D:/python/Project_Stock-main/pic/reset.png',size_hint=(None,None ),height=70,width=70)
